...
const SECURE_FUNCS = new Set(['getCompanyData', 'buzonNotificaciones', 'incidentNotifications', 'uploadArchivo', 'importDatosEmpresa', 'dailyBackupToDrive', 'cascadeDeactivate']);
