...
export default function Home() {
  ...
  // Próximas revisiones (equipos con next_revision_date en los próximos 30 días)
          ...
          <div className="max-w-7xl mx-auto p-6 space-y-6">
            {loadingClientData ? (
              ...
              <Card className="p-8 text-center bg-white/10 border-white/20">
                <p className="text-slate-400">No tienes datos asociados a tu cuenta.</p>
              </Card>
            )}
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          {/* Alertas: Próximas revisiones e incidencias pendientes */}
