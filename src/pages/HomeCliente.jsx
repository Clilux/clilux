        ...
        <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          <>
              ...
              <Link to={createPageUrl(`IncidentForm?client_id=${clientId}&mode=client`)}>
                <Card className="bg-red-500/20 text-card-foreground my-4 p-5 rounded-xl border shadow border-red-500/30 hover:bg-red-500/30 transition-all cursor-pointer">
                  <div className="flex items-center gap-4">
