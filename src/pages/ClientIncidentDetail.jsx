      ...
      <div className="min-h-screen bg-white p-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-2xl font-semibold text-slate-800">Incidencia</h1>
          </div>
          <Card className="p-12 bg-white border text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex gap-3">
                ...
                <Button onClick={() => navigate(createPageUrl('HomeCliente'))} variant="outline">
    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-semibold text-slate-800">Detalle de Incidencia</h1>
        </div>
