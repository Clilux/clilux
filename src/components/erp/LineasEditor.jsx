...
/** Editor de líneas de un documento ERP (concepto, cantidad, precio, descuento). */
export default function LineasEditor({ lineas = [], onChange, iva = IVA_DEFECTO }) {
  ...
  return (
    <div className="space-y-2">
      ...
      {lineas.length === 0 && (
        <p className="text-xs text-slate-400 py-2">Sin líneas todavía. Pulsa «Añadir» para empezar.</p>
      )}
