...
import { Search, FileText, Loader2, Plus, Trash2, ExternalLink } from 'lucide-react';
            ...
            <div className="space-y-2">
              {lineas.map((l, i) => (
                <div key={i} className="grid grid-cols-12 gap-2 items-center">
                  ...
                  <div className="col-span-1 text-xs text-slate-400 text-right font-medium">
                    {(l.cantidad * l.precio).toFixed(2)}€
                  </div>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="col-span-1 h-7 w-7 text-slate-300 hover:text-red-400"
              ...
              <div className="text-right text-sm font-semibold text-slate-700 pr-9">
