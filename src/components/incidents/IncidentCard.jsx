...
import { AlertTriangle, Clock, User, ChevronRight, Trash2, FileText } from 'lucide-react';
...
export default function IncidentCard({ incident, equipmentName, buildingName, showClient = false, clientName, onDelete }) {
  ...
  return (
    <Card
      ...
      className="p-5 bg-white border-0 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 cursor-pointer group"
    >
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            size="sm"
            onClick={goAlbaran}
            className="text-blue-600 hover:text-blue-700 hover:bg-blue-50 gap-1 opacity-0 group-hover:opacity-100 transition-opacity"
